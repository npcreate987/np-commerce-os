...
const tabs = [
  { href: '/rider/dashboard', label: 'งาน' },
  { href: '/rider/history', label: 'ประวัติ' },
];

export default function RiderLayout({ children }: { children: ReactNode }): JSX.Element | null {
    ...
    <div className="min-h-dvh bg-gray-50 pb-20">
      <header className="sticky top-0 z-20 border-b border-gray-100 bg-white">
        <div className="container-mobile flex h-12 items-center justify-between">
          <span className="text-sm font-bold text-brand">NP Rider</span>
