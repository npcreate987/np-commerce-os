 ...
 *
 * Position
 *   - **Mobile (<lg)** — hidden. The TikTok-style centre "+" button in the
 *     bottom nav (`CustomerBottomNav`) is the canonical create entrypoint on
 *     mobile, so a duplicate floating button would be visual noise.
