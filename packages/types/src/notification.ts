...
/** "topic" categorises why a message is being sent (used for opt-out granularity). */
export const notificationTopicSchema = z.enum([
  'TRANSACTIONAL', // payment, order status — opt-out ไม่ได้
  'PROMOTIONAL', // marketing broadcast / flash deal
  'REVIEW_REMINDER',
  'CS_REPLY', // chatbot/support → Phase 9.3
  'SYSTEM',
]);
...
// =============================================================================
// Native Device Token (Capacitor → FCM / APNs)
// =============================================================================
...
export const notificationStatusSchema = z.enum([
  'OK',
  'FAIL',
  'SKIPPED', // muted / no subscription / invalid recipient
]);
...
export interface NotificationPayload {
  ...
  body: string;
  url?: string;
  /** kebab-case identifier — used in service worker click handler / FCM */
  tag?: string;
  imageUrl?: string;
  /** Free-form extra; serialised when crossing wire */
  data?: Record<string, string>;
}

// =============================================================================
// Public config (frontend needs VAPID public key)
// =============================================================================
